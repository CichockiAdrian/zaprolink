...
import { posts, categories, getFeaturedPost, getPostsByCategory } from '../data/blogData';
...
export default function BlogList() {
  ...
  const filteredPosts = getPostsByCategory(activeCategory)
    .filter((p) => p.slug !== featuredPost.slug) // wyróżniony nie pojawia się w siatce
    .filter((p) => {
  ...
  return (
    <div className="min-h-screen bg-white py-20">
      <div className="max-w-[1280px] mx-auto px-6 lg:px-12">
        ...
        {/* Wyróżniony post — pokazuje się tylko gdy brak filtrów/wyszukiwania */}
          ...
          {categories.map((cat) => (
            <button
              ...
              onClick={() => {
                ...
                setSearchQuery(''); // reset wyszukiwania przy zmianie kategorii
              }}
        ...
        {filteredPosts.length > 0 ? (
          ...
          <div className="text-center py-16 text-[#9CA3AF]">
            ...
            <p className="text-sm">Spróbuj innej kategorii lub frazy wyszukiwania</p>
            <button
