...
// W dev nie generujemy nic statycznie, żeby nie muliło
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <article className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div
          className="prose prose-lg max-w-none prose-headings:font-['Playfair_Display'] prose-headings:text-[#111827] prose-p:text-[#374151] prose-li:text-[#374151]"
              ...
              <Link key={p.slug} href={`/blog/${p.slug}`}>
                <Card className="overflow-hidden hover:shadow-lg transition-shadow group">
                  ...
                  <div className="p-4">
                    ...
                    <p className="font-medium text-[#111827] text-sm line-clamp-2">
                      {p.title}
                    </p>
                  </div>
                </Card>
