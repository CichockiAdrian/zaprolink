      ...
      <div className="max-w-[1280px] mx-auto px-6 lg:px-12">
        <div className="flex items-center justify-between h-[72px]">
          ...
          <div className="hidden md:flex items-center gap-8">
            <Link href="/szablony" className="text-[#6B7280] hover:text-[#111827] transition-colors">
              Szablony
            </Link>
            <Link href="/cennik" className="text-[#6B7280] hover:text-[#111827] transition-colors">
              Cennik
            </Link>
          ...
          <div className="md:hidden py-4 border-t border-neutral-200">
            <div className="flex flex-col gap-4">
              ...
              <div className="pt-2 border-t border-neutral-200 flex flex-col gap-2">
                ...
                >
                  <Link href="/onboarding/okazja" onClick={() => setMobileMenuOpen(false)}>
                    Stwórz za darmo
                  </Link>
                </Button>
              </div>
